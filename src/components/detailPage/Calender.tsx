...
export const Calender = ({ id }: { id: number }): JSX.Element => {
  ...
  return (
    <div className="calendar-container p-4 rounded-1.5 border border-gray--100 h-[640px] max-lg:h-min ">
      ...
      <div className="">
        <div className="grid grid-cols-3 max-md:grid-cols-2 gap-2 py-4">
